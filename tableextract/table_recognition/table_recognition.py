...
class TableRecognizer:
    ...
    def __init__(self, weights_path=None):
        ...
        logging.info("Traditional table recognition initialized")

    def process(self, image, table_list: list = None) -> List[Table]:
        """Traditional table detection and recognition method"""
        # bin
        ...
        vline = cv2.morphologyEx(
            bin_image, cv2.MORPH_OPEN, np.ones((image.shape[0] // 100, 1))
        )
